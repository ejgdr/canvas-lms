...
| Command | `bundle exec rspec spec/controllers/discussion_topics_controller_spec.rb --example "discussion_thread_summarizer_enabled" --format documentation` |
| Outcome | Exit code 0; `2 examples, 0 failures` (finished in 6.58 seconds) |
| `QA Status` | `Pass` |
